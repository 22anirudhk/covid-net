...
state_data = state_data.drop(54, 1)
state_data = state_data.drop(55, 1)
state_data = state_data.drop("Connecticut", 1)
state_data = state_data.drop("Delaware", 1)
state_data = state_data.drop("Diamond Princess", 1)
state_data = state_data.drop("District of Columbia", 1)
state_data = state_data.drop("Grand Princess", 1)
state_data = state_data.drop("Hawaii", 1)
state_data = state_data.drop("Rhode Island", 1)
state_data = state_data.drop("Virgin Islands", 1)

new_data = new_data.drop("Connecticut Predict", 1)
new_data = new_data.drop("Delaware Predict", 1)
new_data = new_data.drop("Diamond Princess Predict", 1)
new_data = new_data.drop("District of Columbia Predict", 1)
new_data = new_data.drop("Grand Princess Predict", 1)
new_data = new_data.drop("Hawaii Predict", 1)
new_data = new_data.drop("Rhode Island Predict", 1)
new_data = new_data.drop("Virgin Islands Predict", 1)
